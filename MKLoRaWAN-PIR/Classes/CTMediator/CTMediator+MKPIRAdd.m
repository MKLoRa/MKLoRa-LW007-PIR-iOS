...
@implementation CTMediator (MKPIRAdd)

- (UIViewController *)CTMediator_LORAWAN_PIR_AboutPage {
    ...
    return [self performTarget:kTarget_loRaApp_pir_module
                        action:kAction_loRaApp_pir_aboutPage
                        params:@{}
             shouldCacheTarget:NO];
}
