...
@interface MKPIRAboutController ()
...
@implementation MKPIRAboutController

- (void)dealloc {
    NSLog(@"MKPIRAboutController销毁");
}
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKLoRaWAN-PIR", @"MKPIRAboutController", @"pir_aboutIcon.png");
    }
    return _aboutIcon;
}
...
- (UIImageView *)bottomIcon {
    if (!_bottomIcon) {
        ...
        _bottomIcon.image = LOADICON(@"MKLoRaWAN-PIR", @"MKPIRAboutController", @"pir_aboutBottomIcon.png");
    }
    return _bottomIcon;
}
