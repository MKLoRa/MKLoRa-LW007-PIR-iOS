//
//  MKPIRBatteryConsumptionController.m
...
#import "MKPIRBatteryConsumptionModel.h"

#import "MKPIRBatteryInfoForV2Cell.h"


@interface MKPIRBatteryConsumptionController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKPIRBatteryConsumptionModel *dataModel;

@end

@implementation MKPIRBatteryConsumptionController

- (void)dealloc {
    NSLog(@"MKPIRBatteryConsumptionController销毁");
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        MKPIRBatteryInfoForV2Cell *cell = [MKPIRBatteryInfoForV2Cell initCellWithTableView:tableView];
...
- (void)loadSection0Datas {
    MKPIRBatteryInfoForV2CellModel *cellModel = [[MKPIRBatteryInfoForV2CellModel alloc] init];
...
- (MKPIRBatteryConsumptionModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKPIRBatteryConsumptionModel alloc] init];
    }
    return _dataModel;
}
