//
//  MKPIRBatteryConsumptionModel.m
...
@interface MKPIRBatteryConsumptionModel ()
...
@implementation MKPIRBatteryConsumptionModel
...
- (BOOL)readLast {
    __block BOOL success = NO;
    [MKPIRInterface pir_readLastCycleBatteryInformationWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readAll {
    __block BOOL success = NO;
    [MKPIRInterface pir_readAllCycleBatteryInformationWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
