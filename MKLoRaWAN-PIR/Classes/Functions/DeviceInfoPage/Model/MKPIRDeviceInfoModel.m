...
@implementation MKPIRDeviceInfoModel
...
- (BOOL)readDeviceModel {
    __block BOOL success = NO;
    [MKPIRInterface pir_readDeviceModelWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSoftware {
    __block BOOL success = NO;
    [MKPIRInterface pir_readSoftwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readFirmware {
    __block BOOL success = NO;
    [MKPIRInterface pir_readFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHardware {
    __block BOOL success = NO;
    [MKPIRInterface pir_readHardwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
