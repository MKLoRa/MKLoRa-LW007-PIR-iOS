...
@interface MKPIRButtonMsgCellModel : NSObject
...
@protocol MKPIRButtonMsgCellDelegate <NSObject>
...
@interface MKPIRButtonMsgCell : MKBaseCell

@property (nonatomic, strong)MKPIRButtonMsgCellModel *dataModel;

@property (nonatomic, weak)id <MKPIRButtonMsgCellDelegate>delegate;
