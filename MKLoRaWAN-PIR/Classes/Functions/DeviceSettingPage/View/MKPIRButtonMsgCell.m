...
@implementation MKPIRButtonMsgCellModel
...
@implementation MKPIRButtonMsgCell

+ (MKPIRButtonMsgCell *)initCellWithTableView:(UITableView *)tableView {
    MKPIRButtonMsgCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKPIRButtonMsgCellIdenty"];
    if (!cell) {
        cell = [[MKPIRButtonMsgCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKPIRButtonMsgCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKPIRButtonMsgCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKPIRButtonMsgCellModel.class]) {
        return;
    }
