...
@implementation MKPIRLoRaPageModel
...
- (BOOL)readNetworkStatus {
    __block BOOL success = NO;
    [MKPIRInterface pir_readLorawanNetworkStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
