...
@implementation MKPIRPCBAStatusCellModel
@end

@interface MKPIRPCBAStatusCell ()
...
@implementation MKPIRPCBAStatusCell

+ (MKPIRPCBAStatusCell *)initCellWithTableView:(UITableView *)tableView {
    MKPIRPCBAStatusCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKPIRPCBAStatusCellIdenty"];
    if (!cell) {
        cell = [[MKPIRPCBAStatusCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKPIRPCBAStatusCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKPIRPCBAStatusCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKPIRPCBAStatusCellModel.class]) {
        return;
    }
