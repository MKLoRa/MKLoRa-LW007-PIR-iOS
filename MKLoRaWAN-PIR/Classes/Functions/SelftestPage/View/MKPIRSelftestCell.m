...
@implementation MKPIRSelftestCellModel
@end

@interface MKPIRSelftestCell ()
...
@implementation MKPIRSelftestCell

+ (MKPIRSelftestCell *)initCellWithTableView:(UITableView *)tableView {
    MKPIRSelftestCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKPIRSelftestCellIdenty"];
    if (!cell) {
        cell = [[MKPIRSelftestCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKPIRSelftestCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKPIRSelftestCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKPIRSelftestCellModel.class]) {
        return;
    }
