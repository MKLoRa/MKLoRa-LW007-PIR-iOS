...
@interface MKPIRUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKPIRDFUModule *dfuModule;
...
@implementation MKPIRUpdateController

- (void)dealloc {
    NSLog(@"MKPIRUpdateController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_pir_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [MKPIRCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_pir_centralDeallocNotification" object:nil];
...
- (MKPIRDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKPIRDFUModule alloc] init];
    }
    return _dfuModule;
}
