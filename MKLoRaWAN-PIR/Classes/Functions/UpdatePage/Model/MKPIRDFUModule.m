...
@interface MKPIRDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKPIRDFUModule

- (void)dealloc{
    NSLog(@"MKPIRDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKPIRCentralManager shared].peripheral];
}
