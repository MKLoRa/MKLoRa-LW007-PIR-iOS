...
static MKPIRUserLoginManager *loginManager = nil;
static dispatch_once_t onceToken;

@interface MKPIRUserLoginManager ()
...
+ (MKPIRUserLoginManager *)shared {
    dispatch_once(&onceToken, ^{
        if (!loginManager) {
            loginManager = [MKPIRUserLoginManager new];
        }
    });
    return loginManager;
}
