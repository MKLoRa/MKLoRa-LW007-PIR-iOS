...
/**
 线程ID
 */
@property (nonatomic, assign)mk_pir_taskOperationID operationID;
...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic {
    [self dataParserReceivedData:[MKPIRTaskAdopter parseReadDataWithCharacteristic:characteristic]];
}

- (void)peripheral:(CBPeripheral *)peripheral didWriteValueForCharacteristic:(CBCharacteristic *)characteristic {
    [self dataParserReceivedData:[MKPIRTaskAdopter parseWriteDataWithCharacteristic:characteristic]];
}
...
- (void)dataParserReceivedData:(NSDictionary *)dataDic{
    ...
    mk_pir_taskOperationID operationID = [dataDic[@"operationID"] integerValue];
    if (operationID == mk_pir_defaultTaskOperationID || operationID != self.operationID) {
        return;
    }
